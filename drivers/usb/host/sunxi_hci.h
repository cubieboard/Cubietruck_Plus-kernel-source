...
struct sunxi_hci_hcd{
	...
	script_item_u drv_hsic_PE16;
	script_item_u drv_hsic_PE17;
	script_item_u drv_hsic_PH5;
	...
	u32 drv_hsic_PE16_valid;
	u32 drv_hsic_PE17_valid;
	u32 drv_hsic_PH5_valid;
	...
	void (* set_usbc_regulator)(struct sunxi_hci_hcd *sunxi_hci, int is_on);
